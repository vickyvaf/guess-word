                ...
                >
                    {loading ? (
                        <div style={{ textAlign: "center" }}>
                            <span style={{ fontSize: "0.9rem", color: "#4b5563" }}>Loading...</span>
                        </div>
                    ) : user ? (
                        <>
                            <div
                                style={{
                                    ...
                                    fontWeight: 700,
                                    fontSize: "1.5rem",
                                    color: user.user_metadata?.avatar_url ? "transparent" : "white",
                                }}
                                title={getUserDisplayName()}
                            >
                                {user.user_metadata?.avatar_url ? "" : getUserInitials(user.email)}
                            </div>

                            <div
                                style={{ display: "grid", lineHeight: 1.2, textAlign: "center" }}
                            >
                                <span style={{ fontWeight: 700 }}>{getUserDisplayName()}</span>
...
function BackgroundMusicVolumeSlider() {
    ...
    return (
        <div style={{ display: "grid", gap: "1rem", marginTop: "1rem" }}>
            <label style={{ display: "grid", gap: "0.5rem" }}>
                <span style={{ fontWeight: 600 }}>Background Music: {backgroundMusicVolume}%</span>
                <input
                    type="range"
                    min={0}
                    max={100}
